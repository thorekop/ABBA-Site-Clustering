    ...
    do
        ...
        do
            ...
            do
                ...
                for res in ../res/snaq/pop_size_1e5_div_time_${div_time}_rec_rate_1e-8_mut_rate_2e-9_intr_rate_${intr_rate}_P2_rate_${P2_rate}_r*/iqtree_${alignment_length}_snaq_sum.txt
                do
