...
# Write headerline.
echo -e "pop_size\tdiv_time\trec_rate\tmut_rate\tintr_rate\tP2_rate\trun\tp_value1\tp_value2" > ../res/tables/abba_clustering_mut_rate_var.txt

# Take file IDs.
for file in ../res/dsuite_20231030/pop_size*_*mut_rate_var_*ks_tree.txt
do
