...
newick_string = "(((P1:" + str(div_time + P_default_sampling_time) + ",P2:" + str(div_time + P_default_sampling_time) + "):1000000,P3:" + str(div_time + 1000000 + P_default_sampling_time) + "):10000000,P4:" + str(div_time + 11000000 + P_default_sampling_time) + ")"
