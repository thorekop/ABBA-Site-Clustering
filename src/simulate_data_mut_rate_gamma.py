...
use_var_mut_rate = False
if sys.argv[5] == "varGamma":
    use_var_mut_rate = True
    ...
    while current_pos + mut_map_window_size < seq_length:
        ...
        mut_map_rates.append(np.random.gamma(shape=2, scale=(2e-9)/2)) # hardcoding the mean mutation rate for variable rates.
