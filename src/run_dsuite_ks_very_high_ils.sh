# thore Tue Jan 16 14:36:02 CET 2024
...
mkdir -p ../res/dsuite/very_high_ils
mkdir -p ../log/dsuite/very_high_ils
...
for vcf in ../res/msprime/very_high_ils/pop_size_*_div_time_*_rec_rate_*.vcf
do
    ...
    # Set the prefix.
    prefix=../res/dsuite/very_high_ils/${vcf_id}_ks
	...
	then
	    ...
	    # Set the log file.
	    log=../log/dsuite/very_high_ils/${vcf_id}_ks.txt
	    rm -f ${log}
