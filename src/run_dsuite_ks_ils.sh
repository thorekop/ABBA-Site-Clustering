...
mkdir -p ../res/dsuite/ils
mkdir -p ../log/dsuite/ils
...
for vcf in ../res/msprime/ils/pop_size_*_div_time_*_rec_rate_*.vcf
do
    ...
    # Set the prefix.
    prefix=../res/dsuite/ils/${vcf_id}_ks
